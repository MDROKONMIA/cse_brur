...
const Footer = () => {
    ...
    const quickLInks = [
        ...
        { title: "Facebook", url: fbPageLinks },
    ]
    const FollowUsLinks = [
        { title: "Facebook", url: fbPageLinks },
        { title: "Twitter", url: "#" },
    ...
    return (
        <footer className="p-4 sm:p-6 bg-primary_bg dark:bg-gray-900 mt-2">
            <div className=" lg:flex md:justify-between">
                ...
                <div className="">
                        ...
                        <div>
                            ...
                            <ul className="text-gray-300 dark:text-gray-400">
                                ...
                                {quickLInks ? quickLInks.map((el => (
                                    <li className="mb-4">
                                        <a className='text-gray-300 hover:text-white dark:hover:text-white  hover:font-semibold' href={el.url}>{el.title}</a>
                                    </li>
                                ))) : ""}
                                {/* End Quick Linkes  */}
                    ...
                    <div className='capitalize border-t-2 border-black border-double'>
                        ...
                        <p className='capitalize text-white'> 2nd Floor, Academic Building #02, Begume Rokeya University, Rangpur. Park Mor, Modern, Rangpur-5404, Bangladesh.</p>
                    </div>
                    <div className='capitalize border-t-2 border-black border-double'>
                        <div className='w-full text-center font-semibold text-white'>Contact:</div>
                        <p className='capitalize text-white'>Mobile:+8801781013468</p>
                    </div>
                </div>
            </div>
            <hr className="my-6 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8" />
            <div className="sm:flex sm:items-center sm:justify-between">
                <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <Link to="/" className="hover:underline">CSE BRUR™</Link>. All Rights Reserved.
                </span>
                <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                    <Link to={fbPageLinks} target={"_blank"} className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
